<?php $__env->startSection('title', 'Verify Your Identity'); ?>
...
<div class="mb-8 text-center">
    ...
    <p class="text-zinc-400 text-sm mt-2 px-4">
        ...
        <span class="text-emerald-400 font-medium"><?php echo e($email); ?></span>
    </p>
</div>

<form method="POST" action="<?php echo e(route('otp.submit')); ?>" class="space-y-6">
    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
            <p class="text-red-400 text-xs mt-2 text-center"><?php echo e($message); ?></p>
        <?php unset($message);
...
<a href="<?php echo e(route('login')); ?>" class="inline-flex items-center text-zinc-500 hover:text-emerald-500 text-sm transition font-medium">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Isaac\Desktop\E-learning\resources\views/auth/verify_otp.blade.php ENDPATH**/ ?>