        ...
        <nav class="space-y-1">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group
                      <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[var(--accent-primary)]/10 text-accent' : 'text-secondary hover:surface-muted hover:text-primary'); ?>">
                <?php echo e(svg('heroicon-o-squares-2x2', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Dashboard
            </a>
            ...
            <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-users', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Users Management
            </a>

            <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-academic-cap', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Courses
            </a>
            ...
            <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-chart-bar', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Analytics
            </a>

            <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-clock', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Activity Logs
            </a>

             <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-server', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                System Status
            </a>
            ...
            <p class="px-3 text-xs font-semibold text-secondary uppercase tracking-wider mt-6 mb-2">
             ...
             <a href="#" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                <?php echo e(svg('heroicon-o-cog-6-tooth', 'w-5 h-5 mr-3 flex-shrink-0')); ?>
                Settings
            </a>
        </nav>
        ...
        <div class="mt-auto border-t border-subtle pt-4">
            ...
            <form method="POST" action="">
                ...
                <button type="submit" class="w-full flex items-center px-3 py-2 text-sm font-medium text-error rounded-lg hover:bg-error/10 transition-colors">
                    <?php echo e(svg('heroicon-o-arrow-left-on-rectangle', 'w-5 h-5 mr-3')); ?>
                    Sign Out
                </button>
            </form>
        </div>
...
<?php /**PATH C:\Users\Isaac\Desktop\E-learning\resources\views/components/layout/admin-sidebar.blade.php ENDPATH**/ ?>