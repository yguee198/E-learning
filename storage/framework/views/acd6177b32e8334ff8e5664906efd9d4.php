...
<div class="space-y-6">
        ...
        <div class="bg-zinc-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($enrolledCourses); ?></p>
                </div>
        ...
        <div class="bg-zinc-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($progress); ?>%</p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <a href="<?php echo e(route('profile.edit')); ?>" class="bg-zinc-800 rounded-lg shadow p-6 hover:shadow-lg transition">
        ...
        <a href="#" class="bg-zinc-800 rounded-lg shadow p-6 hover:shadow-lg transition">
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Isaac\Desktop\E-learning\resources\views/dashboard/student.blade.php ENDPATH**/ ?>