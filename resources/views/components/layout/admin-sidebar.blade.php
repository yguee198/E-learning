...
>
    ...
    <div class="h-[calc(100vh-4rem)] overflow-y-auto custom-scrollbar p-4 flex flex-col justify-between">
        ...
        <nav class="space-y-6">
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group
                        ...
                        @svg('heroicon-o-presentation-chart-line', 'w-5 h-5 mr-3 flex-shrink-0')
                        Overview
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-signal', 'w-5 h-5 mr-3 flex-shrink-0')
                        Live Activity
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-key', 'w-5 h-5 mr-3 flex-shrink-0')
                        Permissions
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-book-open', 'w-5 h-5 mr-3 flex-shrink-0')
                        Courses Review
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-flag', 'w-5 h-5 mr-3 flex-shrink-0')
                        Flagged Content
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-clipboard-document-list', 'w-5 h-5 mr-3 flex-shrink-0')
                        Attendance
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-folder-open', 'w-5 h-5 mr-3 flex-shrink-0')
                        Portfolios
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-chat-bubble-left-right', 'w-5 h-5 mr-3 flex-shrink-0')
                        Chat Moderation
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-cpu-chip', 'w-5 h-5 mr-3 flex-shrink-0')
                        AI Monitoring
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-bell', 'w-5 h-5 mr-3 flex-shrink-0')
                        Notifications
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-list-bullet', 'w-5 h-5 mr-3 flex-shrink-0')
                        System Logs
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-shield-check', 'w-5 h-5 mr-3 flex-shrink-0')
                        Audit & Security
                    </a>
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-lock-closed', 'w-5 h-5 mr-3 flex-shrink-0')
                        Access Logs
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="#" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors group text-secondary hover:surface-muted hover:text-primary">
                        @svg('heroicon-o-puzzle-piece', 'w-5 h-5 mr-3 flex-shrink-0')
                        Integrations
                    </a>
                </div>
            </div>
        ...
        <!-- User Profile & Logout -->
        <div class="mt-8 border-t border-subtle pt-4 pb-2">
